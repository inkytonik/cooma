...
class FileIoTests extends ExecutionTests {
  ...
  {
    val sourceFilename =
      "src/test/resources/capability/folderReaderCmdArg.cooma"
  ...
  {
    val sourceFilename =
      "src/test/resources/capability/folderWriterCmdArg.cooma"
  ...
  {
    val sourceFilename =
      "src/test/resources/capability/folderReaderDescendantCheckFail.cooma"
    val name =
      s"FolderWriter command arguments ($sourceFilename): descendant check fail"
