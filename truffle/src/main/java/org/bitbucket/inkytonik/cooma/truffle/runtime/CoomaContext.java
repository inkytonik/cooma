...
/**
 *
 * The run-time state of Cooma during execution. The context is created by the
 * {@link CoomaLanguage}. If two separate scripts run in one Java VM at the same
 * time, they have a different context. Therefore, the context is not a
 * singleton.
 */
