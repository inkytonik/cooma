...
Named types for built-in capabilities are related to record types that provide the capability operations.
...
\inference[T-RD]{
  ...
  \subtype{\kw{Reader}}{\recty{\{ \kw{read} :\funty{}{String} \}}}
}
...
\inference[T-WR]{
  ...
  \subtype{\kw{Writer}}{\recty{\{ \kw{write} :\funty{String}{\recty{\rowety}} \}}}
}
...
\inference[T-RDWR]{
  ...
  \subtype{\kw{ReaderWriter}}{\recty{\{ \kw{read} :\funty{}{String}, \kw{write} :\funty{String}{\recty{\rowety} \}}}}
}
...
\inference[T-APP-F]{
  \infe{\Gamma}{e}{\funty{\repo{t}}{t}} & \len{e} = \len{t} &
  \chke{\Gamma}{\repo{e}}{\repo{t}}
}{
  \infe{\Gamma}{\appe{e}{\repo{e}}}{t}
}
...
\inference[T-APP-P]{
  \infe{\Gamma}{e}{\funty{\repo{t}}{t}} & \len{e} < \len{t} &
  \chke{\Gamma}{\sub{\repo{e}}{0}{\len{e}}}{\sub{\repo{t}}{0}{\len{e}}}
}{
  \infe{\Gamma}{\appe{e}{\repo{e}}}{\funty{\sub{\repo{t}}{\len{e}}{\len{t}}}{t}}
}
...
\inference[T-DEF]{
  \infb{\consc{\Gamma}{\repo{\bnd{x_i}{\funty{\repo{t_i}}{u_i}}}}}{b}{t}
}{
...
\inference[T-REC]{
  ...
  \infe{\Gamma}{\rowe{x}{e}}{\recty{\rowty{x}{t}}}
}
